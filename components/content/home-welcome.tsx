...
export function HomeWelcome({
  ...
  return (
    <section className="container mx-auto px-4 md:px-8">
      <div className="relative overflow-hidden rounded-[36px] border border-white/10 bg-[linear-gradient(148deg,rgba(24,17,10,0.96)_0%,rgba(11,11,11,0.96)_44%,rgba(7,8,10,0.98)_100%)] p-6 shadow-[0_30px_120px_rgba(0,0,0,0.36)] sm:p-7 md:p-8 lg:p-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(200,149,26,0.22),transparent_34%),radial-gradient(circle_at_80%_18%,rgba(255,255,255,0.08),transparent_20%)]" />
        ...
        <div className="relative grid gap-8 xl:grid-cols-[minmax(0,1.18fr)_minmax(350px,0.82fr)] xl:gap-10">
          <div className="space-y-7">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-[11px] uppercase tracking-[0.3em] text-white/36">
                <span className="h-px w-10 rounded-full bg-primary/70" />
                <span>Tu cabina privada</span>
              </div>
              <h2 className="font-display text-3xl font-semibold leading-tight text-white text-balance md:text-[2.8rem]">
              ...
              {!isSubscribed && (
                <Link
                  ...
                  className={cn(
                    ...
                    "rounded-full border-white/15 bg-white/[0.06] px-6 text-sm text-white backdrop-blur-sm hover:bg-white/[0.1] hover:text-white"
                  )}
                >
            ...
            <div className="rounded-[26px] border border-white/10 bg-white/[0.045] p-4 backdrop-blur-sm md:p-5">
          ...
          <div className="grid gap-4">
            <div className="rounded-[30px] border border-white/10 bg-white/[0.055] p-5 backdrop-blur-xl md:p-6">
              <p className="text-[11px] uppercase tracking-[0.28em] text-white/38">
                Estado
              </p>
              <div className="mt-4 flex items-start justify-between gap-4">
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-black/20">
...
function InfoCard({
  ...
  return (
    <div className="rounded-[24px] border border-white/10 bg-white/6 p-4 backdrop-blur-sm md:p-5">
